					...
					for (char fifthDigit = fourthDigit; fifthDigit <= '9'; fifthDigit++) {
						for (char sixthDigit = fifthDigit; sixthDigit <= '9'; sixthDigit++) {
							if ((firstDigit == secondDigit || secondDigit == thirdDigit || thirdDigit == fourthDigit || fourthDigit == fifthDigit || fifthDigit == sixthDigit) &&
								((sixthDigit == fifthDigit && fifthDigit != fourthDigit) ||
								 (firstDigit == secondDigit && secondDigit != thirdDigit) ||
								 (secondDigit == thirdDigit && firstDigit != secondDigit && thirdDigit != fourthDigit) ||
								 (thirdDigit == fourthDigit && secondDigit != thirdDigit && fourthDigit != fifthDigit) ||
								 (fourthDigit == fifthDigit && thirdDigit != fourthDigit && fifthDigit != sixthDigit))) {
								++cnt;
							}
						}
					}	
